...
class Pasajero {
  ...
  agregardescuentoVip(mascotaVip) {
    this.mascotasVip.agregar(mascota);
  }
  // Método para calcular el costo total del pasajero
  calcularCosto(descuentoVIP, pesoLimite, costoPerro, costoGato, descuentoVip) {
    ...
    if (this.mascotas) {
      costo -= (descuentoVip / 0.15) * this.tarifa;
    }
